...
class NeuralNetwork():
    ...
    def run(self):
        ...
        model = Sequential()
        model.add(Dense(units=200, input_shape=(input_dim,), kernel_initializer='random_normal',
        ...
        model.add(Dense(units=200, kernel_initializer='random_normal', bias_initializer='random_normal',
                        activation='sigmoid'))
        model.add(Dense(units=output_dim, activation='relu', kernel_initializer='random_normal',
