...
# load data
x_data = np.loadtxt('x_data_set3')
y_data = np.loadtxt('y_data_set3')
...
model.add(Dense(units=4, activation='relu', kernel_initializer='random_normal', bias_initializer='random_normal'))
