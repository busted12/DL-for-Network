...
x_data = u'/home/chen/MA_python/Vlink_Reconf/Vlink/demand_vector'
y_data = u'/home/chen/MA_python/Vlink_Reconf/Vlink/vlink_vector'
n = NeuralNetwork(x_data, y_data)
n.run()